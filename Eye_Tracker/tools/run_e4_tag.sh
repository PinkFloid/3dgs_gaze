#!/usr/bin/env bash
# run_e4_tag.sh -- E4 追加批:tag 书签戳(只改中心,σ 钉 1.5°,不衰减)± 对象自校准。
...
STAMP="--on-tag-deg 4 --stamp-include 79,86 --stamp-sigma off --bias-tau 0"
# v2tagcal 砍掉(09-02 18:30):近卡上戳本身错 3°,自校准接在错锚后面没有意义;v2tag 保留为负结果行
CFGS="v2tag:--rank capture $STAMP"
