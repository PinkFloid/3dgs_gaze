#!/usr/bin/env bash
# run_e4_sigma2.sh -- E4 追加批:锥宽 σ 往下扫(v2 口径,半角 2σ):σ=1.0° / 0.5° / 0.2°(≈单射线)。
...
CFGS="v2s10:--rank capture --sigma-deg 1.0
v2s05:--rank capture --sigma-deg 0.5
v2s02:--rank capture --sigma-deg 0.2"
...
echo "== E4 sigma2 批跑完毕 $(date +%H:%M:%S)"
