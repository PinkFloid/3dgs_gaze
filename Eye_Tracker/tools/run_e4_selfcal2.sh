#!/usr/bin/env bash
# run_e4_selfcal2.sh -- E4 追加批:对象自校准 v2selfcal2 = 无歧义门放宽到 0.2、至少 2 个物体、观测门 0.2。
...
CFGS="v2selfcal2:--rank capture --selfcal on --selfcal-min-objects 2 --selfcal-max-second 0.2 --selfcal-min-capture 0.2"
...
echo "== E4 selfcal2 批跑完毕 $(date +%H:%M:%S)"
